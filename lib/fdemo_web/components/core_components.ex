defmodule FdemoWeb.CoreComponents do
  @moduledoc """
  ...
  def core_input(%{type: "select"} = assigns) do
    ~H"""
    <div>
      <.core_label for={@id}>{@label}</.core_label>
      <select
        id={@id}
        name={@name}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FdemoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FdemoWeb.Gettext, "errors", msg, opts)
    end
  end
